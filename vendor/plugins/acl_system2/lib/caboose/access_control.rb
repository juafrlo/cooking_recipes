...
module Caboose
  ...
  module AccessControl
    ...
    # mis_recetas.com
    # We want:
    #	- If user has no logged in, user can browse
    #	- If user has logged in, have some restrictions considering the user role
    def restrict_to(logicstring, context = {})
       # This if is for mis_recetas.com, but what it is inside if the plugin
      if (current_user.login rescue nil) 
